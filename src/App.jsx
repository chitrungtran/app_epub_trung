...
export default function App() {
  ...
  // --- LOGIC LOAD SÁCH (CÓ GIẢI MÃ ẨN LINK) ---
  useEffect(() => {
    if (isReady && viewerRef.current) {
      ...
      // 👉 KIỂM TRA MÃ HÓA: Nếu link KHÔNG bắt đầu bằng 'http', tức là nó đã bị mã hóa
      if (!urlParam.startsWith('http')) {
         try {
            // Dùng hàm atob để dịch ngược từ Base64 sang link thường
